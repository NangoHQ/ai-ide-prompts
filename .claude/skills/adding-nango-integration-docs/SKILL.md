---
name: adding-nango-integration-docs
...
| Setup guide | `docs/api-integrations/[slug]/how-to-register-your-own-[slug]-oauth-app.mdx` | OAuth app registration steps |
...
- [ ] Create setup guide at `docs/api-integrations/[slug]/how-to-register-your-own-[slug]-oauth-app.mdx`
...
2. `docs/api-integrations/slack/how-to-register-your-own-slack-oauth-app.mdx` - Setup guide
